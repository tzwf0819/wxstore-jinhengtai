...
@router.get("/jinhengtai/admin", response_class=HTMLResponse)
async def admin_home(request: Request):
    return RedirectResponse(url="/jinhengtai/admin/products")

@router.get("/jinhengtai/admin/products", response_class=HTMLResponse)
...
@router.get("/jinhengtai/admin/products/edit/{product_id}", response_class=HTMLResponse)
...
@router.get("/jinhengtai/admin/products/new", response_class=HTMLResponse)
...
@router.post("/jinhengtai/admin/products/new")
async def create_product_web(
    ...
    return RedirectResponse(url="/jinhengtai/admin/products", status_code=303)

@router.post("/jinhengtai/admin/products/edit/{product_id}")
...
@router.get("/jinhengtai/admin/banners", response_class=HTMLResponse)
...
@router.get("/jinhengtai/admin/banners/new", response_class=HTMLResponse)
...
@router.post("/jinhengtai/admin/banners/new")
async def create_banner_web(
    ...
    return RedirectResponse(url="/jinhengtai/admin/banners", status_code=303)

@router.get("/jinhengtai/admin/banners/edit/{banner_id}", response_class=HTMLResponse)
...
@router.post("/jinhengtai/admin/banners/edit/{banner_id}")
...
@router.post("/jinhengtai/admin/banners/delete/{banner_id}")
...
@router.get("/jinhengtai/admin/categories", response_class=HTMLResponse)
...
@router.get("/jinhengtai/admin/categories/new", response_class=HTMLResponse)
...
@router.post("/jinhengtai/admin/categories/new")
async def create_category_web(
    ...
    return RedirectResponse(url="/jinhengtai/admin/categories", status_code=303)

@router.get("/jinhengtai/admin/categories/edit/{category_id}", response_class=HTMLResponse)
...
@router.post("/jinhengtai/admin/categories/edit/{category_id}")
...
@router.post("/jinhengtai/admin/categories/delete/{category_id}")
...
@router.get("/jinhengtai/admin/orders", response_class=HTMLResponse)
...
@router.get("/jinhengtai/admin/orders/{order_id}", response_class=HTMLResponse)
...
@router.get("/jinhengtai/admin/stock", response_class=HTMLResponse)
