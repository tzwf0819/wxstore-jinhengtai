...
async def create_product_web(name: str = Form(...), description: str = Form(None), price: float = Form(...), category: str = Form(...), image_url: str = Form(None), db: Session = Depends(deps.get_db)):
...
async def update_product_web(product_id: int, name: str = Form(...), description: str = Form(None), price: float = Form(...), category: str = Form(...), image_url: str = Form(None), db: Session = Depends(deps.get_db)):
...
# ... (The rest of the admin routes for banners, stock, orders, categories will be added here)
